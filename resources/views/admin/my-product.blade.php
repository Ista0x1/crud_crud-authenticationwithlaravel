			...
			<div class="container">
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="btn btn-danger" arial-current="page" href="{{ url('') }}">My Product</a>
                      </li>
                    ...
                    <tbody>
                      @foreach($products as $product)
                        <tr>
                            ...
                            <td>{{ $product->price }}</td>
                            <td><a class="btn btn-warning" href="{{ url('edit/' . $product->id) }}"><i class="fa fa-edit"></i></a></td>
                            <td><a class="btn btn-danger" href="{{ url('delete/'. $product->id) }}"><i class="fa fa-trash"></i></a></td>
                        </tr>
                      @endforeach
                    </tbody>
                </table>
